...
/** @brief I2C写寄存器 @param hi2c I2C句柄 @param dev_addr 设备地址 @param mem_addr 寄存器地址 @param mem_addr_size 地址长度 @param data 数据缓冲区 @param data_size 数据长度 @param timeout 超时 @return 0=成功 */
extern i32 port_hts221_i2c_write(void* hi2c, u16 dev_addr, u16 mem_addr, u16 mem_addr_size, u8* data, u16 data_size, u32 timeout);
/** @brief I2C读寄存器 @param hi2c I2C句柄 @param dev_addr 设备地址 @param mem_addr 寄存器地址 @param mem_addr_size 地址长度 @param data 数据缓冲区 @param data_size 数据长度 @param timeout 超时 @return 0=成功 */
