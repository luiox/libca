...
public:
    ...
    void addOption(OptionType type, std::string shortName, std::string longName, std::string description, std::function<void(std::string)> handler);
    void addSubCommand(std::string name, std::string description, std::function<void(std::string)> handler);
