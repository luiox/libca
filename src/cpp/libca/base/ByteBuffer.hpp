...
public:
    ByteBuffer() : position_(0), limit_(0), capacity_(0), buffer_(nullptr), mark_(0) {}

    ByteBuffer(size_t size) : position_(0), limit_(size), capacity_(size), buffer_(new uint8_t[size]), mark_(0) {}
