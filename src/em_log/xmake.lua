...
local em_log_test_dir = "$(projectdir)/tests/em_log"

target("test-log")
    set_kind("binary")
    add_rules("em_test", { test_enable = true, use_default_main = true })
    add_includedirs(".", em_log_test_dir)
    add_files("log.c", path.join(em_log_test_dir, "test_log.c"))
    add_files("../em_dstream/ring_buffer.c")
    add_files("../em_platform/async.c")
    add_files("../em_platform/time_util.c")
...
target("test-simple_logger")
    ...
    add_rules("em_test", { test_enable = true, use_default_main = true })
    add_includedirs(".", em_log_test_dir)
    add_files("simple_logger.c", path.join(em_log_test_dir, "test_simple_logger.c"))
    add_deps("libca.em_base")
