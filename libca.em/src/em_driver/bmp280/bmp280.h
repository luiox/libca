...
/// @return 0 表示成功
///
extern i32 port_bmp280_i2c_read(void* hi2c, u16 dev_addr, u16 mem_addr, u16 mem_addr_size, u8* data,
...
/// @return 0 表示成功
///
extern i32 port_bmp280_i2c_write(void* hi2c, u16 dev_addr, u16 mem_addr, u16 mem_addr_size,
