...
CA_WEAK i32 port_bmp180_i2c_write(void* hi2c, u16 dev_addr, u16 mem_addr, u16 mem_addr_size,
...
CA_WEAK i32 port_bmp180_i2c_read(void* hi2c, u16 dev_addr, u16 mem_addr, u16 mem_addr_size,
                                 u8* data, u16 data_size, u32 timeout)
{
    unused_param(hi2c);
    unused_param(dev_addr);
