...
#    define SGP30_PORT_I2C_WRITE(hi2c, dev, mem, memsz, data, len, to) \
        port_sgp30_i2c_write((hi2c), (dev), (mem), (memsz), (data), (len), (to))
#    define SGP30_PORT_I2C_READ(hi2c, dev, mem, memsz, data, len, to) \
        port_sgp30_i2c_read((hi2c), (dev), (mem), (memsz), (data), (len), (to))
...
#    define SGP30_PORT_I2C_WRITE(hi2c, dev, mem, memsz, data, len, to) \
        g_sgp30_port->i2c_write((hi2c), (dev), (mem), (memsz), (data), (len), (to))
#    define SGP30_PORT_I2C_READ(hi2c, dev, mem, memsz, data, len, to) \
        g_sgp30_port->i2c_read((hi2c), (dev), (mem), (memsz), (data), (len), (to))
