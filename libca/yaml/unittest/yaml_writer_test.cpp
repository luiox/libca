...
bool dom_equal(const YamlValue& a, const YamlValue& b)
{
    ...
    case YamlType::Mapping:
    {
        ...
        for (const auto& m : am) {
            ...
            if (bv == nullptr || !dom_equal(m.second, *bv))
                return false;
        }
        return true;
    }
