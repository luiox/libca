...
{
    if (cnt > remaining())
        return Err(BytesError::Underflow);
    pos_ += cnt;
    return Ok();
}
...
Bytes Bytes::slice(usize begin, usize end) const
{
    if (begin > end || end > len_)
        throw std::out_of_range("Bytes::slice invalid range");
    if (storage_) {
...
Result<u32, BytesError> Bytes::get_u32_be()
{
    if (pos_ + 4 > len_)
        return Err(BytesError::Underflow);
    u32 v = (static_cast<u32>(ptr_[pos_]) << 24) | (static_cast<u32>(ptr_[pos_ + 1]) << 16) |
            (static_cast<u32>(ptr_[pos_ + 2]) << 8) | static_cast<u32>(ptr_[pos_ + 3]);
    pos_ += 4;
    return Ok(v);
}
...
Result<u32, BytesError> Bytes::get_u32_le()
{
    if (pos_ + 4 > len_)
        return Err(BytesError::Underflow);
    u32 v = (static_cast<u32>(ptr_[pos_ + 3]) << 24) | (static_cast<u32>(ptr_[pos_ + 2]) << 16) |
            (static_cast<u32>(ptr_[pos_ + 1]) << 8) | static_cast<u32>(ptr_[pos_]);
    pos_ += 4;
    return Ok(v);
}
...
Result<u64, BytesError> Bytes::get_u64_be()
{
    if (pos_ + 8 > len_)
        return Err(BytesError::Underflow);
    u64 v = (static_cast<u64>(ptr_[pos_]) << 56) | (static_cast<u64>(ptr_[pos_ + 1]) << 48) |
            (static_cast<u64>(ptr_[pos_ + 2]) << 40) | (static_cast<u64>(ptr_[pos_ + 3]) << 32) |
            (static_cast<u64>(ptr_[pos_ + 4]) << 24) | (static_cast<u64>(ptr_[pos_ + 5]) << 16) |
            (static_cast<u64>(ptr_[pos_ + 6]) << 8) | static_cast<u64>(ptr_[pos_ + 7]);
    pos_ += 8;
    return Ok(v);
}
...
Result<u64, BytesError> Bytes::get_u64_le()
{
    if (pos_ + 8 > len_)
        return Err(BytesError::Underflow);
    u64 v = (static_cast<u64>(ptr_[pos_ + 7]) << 56) | (static_cast<u64>(ptr_[pos_ + 6]) << 48) |
            (static_cast<u64>(ptr_[pos_ + 5]) << 40) | (static_cast<u64>(ptr_[pos_ + 4]) << 32) |
            (static_cast<u64>(ptr_[pos_ + 3]) << 24) | (static_cast<u64>(ptr_[pos_ + 2]) << 16) |
            (static_cast<u64>(ptr_[pos_ + 1]) << 8) | static_cast<u64>(ptr_[pos_]);
    pos_ += 8;
    return Ok(v);
}
...
void BytesMut::reserve(usize additional)
{
    ...
    if (additional > SIZE_MAX - len_)
        throw std::length_error("BytesMut::reserve size overflow");
...
void BytesMut::put_i16_be(i16 val)
{
    put_u16_be(static_cast<u16>(val));
}
void BytesMut::put_i16_le(i16 val)
{
    put_u16_le(static_cast<u16>(val));
}
void BytesMut::put_i32_be(i32 val)
{
    put_u32_be(static_cast<u32>(val));
}
void BytesMut::put_i32_le(i32 val)
{
    put_u32_le(static_cast<u32>(val));
}
void BytesMut::put_i64_be(i64 val)
{
    put_u64_be(static_cast<u64>(val));
}
void BytesMut::put_i64_le(i64 val)
{
    put_u64_le(static_cast<u64>(val));
}
...
Result<u32, BytesError> BytesMut::get_u32_be()
{
    if (pos_ + 4 > len_)
        return Err(BytesError::Underflow);
    u32 v = (static_cast<u32>(data_[pos_]) << 24) | (static_cast<u32>(data_[pos_ + 1]) << 16) |
...
Result<u32, BytesError> BytesMut::get_u32_le()
{
    if (pos_ + 4 > len_)
        return Err(BytesError::Underflow);
    u32 v = (static_cast<u32>(data_[pos_ + 3]) << 24) | (static_cast<u32>(data_[pos_ + 2]) << 16) |
            (static_cast<u32>(data_[pos_ + 1]) << 8) | static_cast<u32>(data_[pos_]);
    pos_ += 4;
    return Ok(v);
}
...
Result<u64, BytesError> BytesMut::get_u64_be()
{
    if (pos_ + 8 > len_)
        return Err(BytesError::Underflow);
    u64 v = (static_cast<u64>(data_[pos_]) << 56) | (static_cast<u64>(data_[pos_ + 1]) << 48) |
            (static_cast<u64>(data_[pos_ + 2]) << 40) | (static_cast<u64>(data_[pos_ + 3]) << 32) |
            (static_cast<u64>(data_[pos_ + 4]) << 24) | (static_cast<u64>(data_[pos_ + 5]) << 16) |
            (static_cast<u64>(data_[pos_ + 6]) << 8) | static_cast<u64>(data_[pos_ + 7]);
    pos_ += 8;
    return Ok(v);
}
...
Result<u64, BytesError> BytesMut::get_u64_le()
{
    if (pos_ + 8 > len_)
        return Err(BytesError::Underflow);
    u64 v = (static_cast<u64>(data_[pos_ + 7]) << 56) | (static_cast<u64>(data_[pos_ + 6]) << 48) |
            (static_cast<u64>(data_[pos_ + 5]) << 40) | (static_cast<u64>(data_[pos_ + 4]) << 32) |
            (static_cast<u64>(data_[pos_ + 3]) << 24) | (static_cast<u64>(data_[pos_ + 2]) << 16) |
            (static_cast<u64>(data_[pos_ + 1]) << 8) | static_cast<u64>(data_[pos_]);
    pos_ += 8;
    return Ok(v);
}
...
void BytesMut::ensure_writable(usize needed)
{
    ...
    if (needed > SIZE_MAX - len_)
        throw std::length_error("BytesMut::ensure_writable size overflow");
