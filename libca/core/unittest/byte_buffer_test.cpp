...
TEST(BytesTest, GetU32_BigEndian) {
    u8 data[] = {0x01, 0x02, 0x03, 0x04};
    auto b = Bytes::from_static(data, 4);
    EXPECT_EQ(b.get_u32(), 0x01020304u);
}
...
TEST(BytesTest, GetU64_BigEndian) {
    ...
    EXPECT_EQ(b.get_u64(), 0x0102030405060708u);
}
...
TEST(BytesTest, GetValuesSequentially) {
    ...
    EXPECT_EQ(b.get_u16(),   0x0203u);
    EXPECT_EQ(b.get_u32(),   0x04050607u);
    EXPECT_EQ(b.get_u64(),   0x08090A0B0C0D0E0Fu);
}
...
TEST(BytesMutTest, PutU32_BigEndian) {
    ...
    EXPECT_EQ(b.get_u32(), 0xCAFEBABEu);
}
...
TEST(BytesMutTest, PutU32_LittleEndian) {
    ...
    EXPECT_EQ(b.get_u32(), 0x04030201u);
}

TEST(BytesMutTest, PutU64) {
    auto b = BytesMut::with_capacity(16);
    b.put_u64(0x0102030405060708u);
    b.put_u64_le(0x0102030405060708u);
    b.advance(0);
    EXPECT_EQ(b.get_u64(), 0x0102030405060708u);
    EXPECT_EQ(b.get_u64(), 0x0807060504030201u);
}
...
TEST(BytesMutTest, PutF64) {
    auto b = BytesMut::with_capacity(8);
    b.put_f64(3.14159265358979);
    b.advance(0);
    EXPECT_NEAR(b.get_f64(), 3.14159265358979, 1e-14);
}
