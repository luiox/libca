...
TEST(StatusTest, Equality)
{
    ...
    EXPECT_EQ(ErrStatus(StatusCode::NOT_FOUND, "x"), Status::error(StatusCode::NOT_FOUND, "x"));
    EXPECT_NE(ErrStatus(StatusCode::NOT_FOUND, "x"), ErrStatus(StatusCode::NOT_FOUND, "y"));
}
