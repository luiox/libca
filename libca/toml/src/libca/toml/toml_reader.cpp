...
ca::Result<TomlDocument, ParseError> TomlReader::read(const ca::str::Utf8StringRef& input,
...
ca::Result<TomlDocument, ParseError> TomlReader::read_file(const ca::str::Utf8StringRef& path,
                                                           const TomlReaderOptions&      options)
{
