...
{
    EXPECT_EQ(SHA3(SHA3::Bits224)(""), "6b4e03423667dbb73b6e15454f0eb1abd4597f9a1b078e3f5b5a6bc7");
...
TEST(Sha3Test, ResetAllowsReuse)
{
    ...
    sha3.add("garbage", 7);
    sha3.reset();
    EXPECT_EQ(sha3("abc"), "3a985da74fe225b2045c172d6bd390bd855f086e3e9d525b46bfe24511431532");
}
