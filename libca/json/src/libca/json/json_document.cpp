...
JsonDocument::JsonDocument() : arena_(), root_() {
    // root_ 默认构造即 null。
}
...
JsonValue& JsonDocument::root() noexcept { return root_; }

const JsonValue& JsonDocument::root() const noexcept { return root_; }

ca::str::Utf8StringArena& JsonDocument::arena() noexcept { return arena_; }
