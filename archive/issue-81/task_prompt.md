...
当年把这两个文件加入git并且commit的时候，我确定你已经完成任务，你应该将当前的`task_plan.md`和`task_prompt.md`文件移动进仓库的`archive/issue-xxx`这个目录下，其中xxx为issue号，最终为`archive/issue-xxx/task_plan.md`这样子的路径。
